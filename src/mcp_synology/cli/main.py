...
@click.version_option(__version__, "-v", "--version", prog_name="mcp-synology")
...
from mcp_synology.cli.check import check  # noqa: E402
from mcp_synology.cli.setup import setup  # noqa: E402
