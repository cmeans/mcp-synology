...
- **Bump github-actions group: actions/checkout →, astral-sh/setup-uv →, actions/setup-python →, codecov/codecov-action →, dependabot/fetch-metadata →, actions/upload-artifact →, actions/download-artifact →, actions/cache →** (#59)
